...
load_from = './weights/yolo_world_v2_x_1280.pth'
log_level = 'ERROR'
...
model = dict(
    backbone=dict(
        ...
        text_model=dict(
            ...
            model_name='./weights/clip-vit-base-patch32',
...
text_channels = 512
text_model_name = './weights/clip-vit-base-patch32'
text_transform = [
    dict(
        max_num_samples=80,
        num_neg_samples=(
...
weight_decay = 0.025
widen_factor = 1.25
work_dir = 'E:\\Project\\DSA\\YoloWorld\\YoloWorld\\log_error'
